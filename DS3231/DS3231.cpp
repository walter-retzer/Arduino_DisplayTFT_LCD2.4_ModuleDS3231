...
char *DS3231::getDOWStr(uint8_t format)
{
	...
	char *daysLong[]  = {"Segunda-Feira", "Terca-Feira", "Quarta-Feira", "Quinta-Feira", "Sexta-Feira", "Sabado", "Domingo"}; //RENOMEADOS AS DATAS EM PORTUGUÊS-BR
	//char *daysShort[] = {"Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"};
	char *daysShort[] = {"Seg", "Ter", "Qua", "Qui", "Sex", "Sab", "Dom"}; //RENOMEADOS AS DATAS EM PORTUGUÊS-BR
	Time t;
	t=getTime();
	if (format == FORMAT_SHORT)
...
char *DS3231::getMonthStr(uint8_t format)
{
    ...
    char *monthLong[]  = {"Janeiro", "Fevereiro", "Marco", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"}; //RENOMEADOS AS DATAS EM PORTUGUÊS-BR
	//char *monthShort[] = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
	char *monthShort[] = {"Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"}; //RENOMEADOS AS DATAS EM PORTUGUÊS-BR
	Time t;
	t=getTime();
	if (format == FORMAT_SHORT)
